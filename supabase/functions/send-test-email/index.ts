...
import { sendSingleViaSMTP } from "../_shared/smtp-sender.ts";
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const authType = emailProvider.smtp_auth_type || "basic";
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="info">
              ...
              Autorizace: ${authType === "oauth2_m365" ? "M365 OAuth2" : emailProvider.smtp_auth_enabled !== false ? "Základní (LOGIN/PLAIN)" : "Ne"}<br>
