...
interface SendTestSummaryEmailProps {
  hasRecipients: boolean;
  isEnabled: boolean;
}

export function SendTestSummaryEmail({ hasRecipients, isEnabled }: SendTestSummaryEmailProps) {
    ...
    <Dialog open={isOpen} onOpenChange={(open) => open ? setIsOpen(true) : handleClose()}>
      <DialogTrigger asChild>
        ...
        >
          ...
          Odeslat testovací souhrnný email
        </Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Toto odešle skutečný souhrnný email všem vybraným příjemcům pro ověření konfigurace.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Tento email bude skutečně odeslán všem vybraným příjemcům. 
