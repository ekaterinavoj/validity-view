...
export function SendTestDeadlineEmail({ hasRecipients, isEnabled }: SendTestDeadlineEmailProps) {
    ...
    <Dialog open={isOpen} onOpenChange={(open) => open ? setIsOpen(true) : handleClose()}>
      <DialogTrigger asChild>
        ...
        >
          ...
          Odeslat testovací souhrnný email (Technické lhůty)
        </Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Odeslat testovací email (Technické lhůty)
          </DialogTitle>
          <DialogDescription>
            Toto odešle skutečný souhrnný email o technických lhůtách všem vybraným příjemcům pro ověření konfigurace.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Tento email bude skutečně odeslán všem vybraným příjemcům technických lhůt. 
